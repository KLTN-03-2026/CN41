      ...
      <div v-else class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <div class="bg-blue-50 rounded-xl p-4 text-left mb-6 space-y-2">
          ...
          <div class="flex items-start gap-2 text-sm text-blue-700">
            <span
              class="w-5 h-5 bg-blue-200 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5"
              >1</span
            >
        ...
        <p class="text-xs text-gray-400 mb-6">
          Không thấy email? Hãy kiểm tra thư mục <strong>Spam</strong> hoặc
...
import { User, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle2 } from 'lucide-vue-next'
import { useStudentAuthStore } from '@/stores/studentAuth.store'

export default {
  components: { Form, Field, User, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle2 },
  setup() {
