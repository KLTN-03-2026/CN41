  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        <div
          v-if="successMessage"
          class="mb-6 p-4 bg-green-50 text-green-700 rounded-lg text-sm flex items-start gap-2 text-left"
        >
        ...
        <div
          v-if="apiError"
          class="mb-4 p-3 bg-red-50 text-red-600 rounded-lg text-sm text-left flex items-start gap-2"
        >
...
export default {
  components: { Mail, CheckCircle2, AlertCircle },
  setup() {
    ...
    const resendVerification = async () => {
      ...
      try {
        ...
        successMessage.value =
          res.data?.message || 'Đã gửi lại email xác thực. Vui lòng kiểm tra hòm thư.'
