  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div
          v-if="successMessage"
          class="mb-5 p-4 bg-green-50 text-green-700 rounded-lg text-sm flex items-start gap-2"
        >
        ...
        <div class="mt-6 text-center">
          <router-link
            to="/login"
            class="text-sm font-medium text-primary-600 hover:text-primary-700 hover:underline inline-flex items-center gap-1"
          >
...
export default {
  components: { Form, Field, Mail, AlertCircle, CheckCircle2, ArrowLeft },
  setup() {
    const apiError = ref('')
    ...
    const onSubmit = async (values) => {
      ...
      try {
        ...
        apiError.value =
          err.response?.data?.message || 'Không thể tạo yêu cầu quên mật khẩu. Vui lòng thử lại.'
      }
    }
