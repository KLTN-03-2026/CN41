<template>
  <div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      >
        <PlusIcon class="w-4 h-4" /> Thêm danh mục
      </button>
    </div>
        ...
        <table class="w-full text-sm">
          <thead>
            <tr class="border-b border-gray-100 bg-gray-50/50">
              <th class="text-left text-xs font-medium text-gray-500 px-4 py-3">Tên danh mục</th>
              <th class="text-left text-xs font-medium text-gray-500 px-4 py-3">Slug</th>
              <th class="text-left text-xs font-medium text-gray-500 px-4 py-3">Mô tả</th>
          ...
          <tbody class="divide-y divide-gray-50">
            ...
            <template v-else-if="categories.length">
              ...
              >
                ...
                <td class="px-4 py-3 text-gray-500 text-xs">{{ formatDate(cat.created_at) }}</td>
            ...
            <form @submit.prevent="submitForm" class="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  class="input-field h-auto py-2 resize-none"
